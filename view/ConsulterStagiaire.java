...
public class ConsulterStagiaire extends JPanel {
	 ...
	 */
	public ConsulterStagiaire(int idCla,String tab,JFrame frame) {
						...
						JLabel lblAjoutDeClasse = new JLabel("Affichage du Stagiaire");
						lblAjoutDeClasse.setBounds(220, 5, 535, 65);
